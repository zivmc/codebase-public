...
import com.android.server.EbbcharService;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
		...
		traceBeginAndSlog("Ebbchar Service");
	    try {
		ServiceManager.addService("ebbchar", new EbbcharService());
	    } catch (Throwable e) {
            reportWtf("starting EbbcharService", e);
	    }
        traceEnd();
        }
